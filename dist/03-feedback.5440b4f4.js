...
forma.addEventListener("input", (0, _lodashThrottleDefault.default)((event)=>{
...
document.querySelector('textarea[name="message"]').value = JSON.parse(ffs).message;
forma.addEventListener("submit", (event)=>{
    ...
    if (email.value == "" || password.value == "") alert("\u0417\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u043F\u043E\u043B\u044F");
    else {
        let obj = {
            email: email.value,
